...
$_SESSION['url']='newdes.php?csid='.$id;
$url=$_SESSION['url'];
...
<section class="et-hero-tabs">
    ...
    <div class="row justify-content-md-center" style="background:white;height:auto">
        <div class="col-md-10" style="height:auto;background:white;font-family:Segoe UI semibold;font-size:18px;text-align:left;color:#0A62A3;">
         <br>   <big> <?php echo $title; ?></big>
            <div class="row" >

                <div class="col-md-12 col-sm-6 col-lg-6" style="margin:14px;height:auto;">

                    <img src="admin/uploads/Courses/<?php echo $title; ?>/image/<?php echo $image; ?>" style="height:auto;width:100%" id="rsimg">


                </div>
                <div class="col-md-12 col-sm-6 col-lg-5" style="margin:14px;height:auto;font-size: 14px">
                    <center>
<?php if($cstype=='module'){  ?>
                        <img src="assets/user/images/nochat.png" style="height:auto;width:100%">
    <?php } if($cstype=='course' && $cert=='1'){?>

    <img src="assets/user/images/combo.png" style="height:auto;width:100%">
    <?php } if($cstype=='course' && $cert!='1'){ ?>
    <img src="assets/user/images/nocert.png" style="height:auto;width:100%">
<?php } ?>
                        <br>
...
<br><br>
                                    <div  style="border:1px dotted #707070;height:40px;width:180px;padding:10px 10px;color:#0A62A3;text-transform:capitalize;">
                                        Free <?php echo $cstype; ?>
                                    </div>
                                            ...
                                            while($row = $checkresult->fetch_assoc()) {?>
                                                ...
                                                <div  class="col-md-6" style="font-size:20px;margin:5px;height:20px;padding:5px 10px;color:#0A62A3;">
                                                    <a href="dashboard.php">
                                                        ...
                                                        <button   Style="width:180px;padding:10px 10px;font-size:16px;border:none; background:#0A62A3; color:white;font-family: Segoe UI semibold">
...
<br>
                                                    <button  name="enroll" Style="width:180px;padding:10px 10px;font-size:16px;border:none; background:#0A62A3; color:white;font-family: Segoe UI semibold">
                                                        Enroll now</button>
                                                </form>
                                            </div>
							...
							<b> Note : </b>	Login As Teacher / Parent to Buy this <?php echo $cstype ?>
								<?php } } else{?>
...
$checksql3= "SELECT * FROM oc where category='course'  and courseid=$id and status='1'";
$checkresult3 = $conn->query($checksql3);
$ucount=$checkresult3->num_rows ;
?>
...
<div class="et-hero-tabs-container">
        ...
        <a class="et-hero-tab" href="#tab-skills">Skills</a>
        <a class="et-hero-tab" href="#tab-instructors">Faculty</a>
        <a class="et-hero-tab" href="#tab-syllabus">Syllabus</a>
...
<main class="et-main">
    ...
    <section class="et-slide" id="tab-skills" style="text-align: left !important;">
...
<div style="width: 100% !important;float: left !important;text-transform:capitalize">
    ...
    <h3 ><big>Skill 4 : <?php echo $skill4 ?></big></h3><br>   <hr/><br>
        ...
        <br>  <br>
            ...
            $instructorsql= "SELECT * FROM instructor where resourceid='$id' and type='course'";
            $instructorresult = $conn->query($instructorsql);
            if ($instructorresult->num_rows > 0) {
            ?>
    <section class="et-slide" id="tab-instructors">
        <br><br><br>   
...
<div class="row"> 
            ...
            <div class="row justify-content-md-start" style="font-family:Segoe UI regular;font-size:16px;text-align:left;color:#0A62A3;">
    ...
    <section class="et-slide" id="tab-syllabus">
        <br><br><br><br><br>
        ...
        <div id="side">
            ...
            <button class="row" id="res" name="resq">
	   ...
	   <?php
                        ...
                        <div class="row   " style="background:white;font-family:Segoe UI regular;font-size:12px;text-align:left;color:#0A62A3;">
                            <?php while($row = $rfileresult->fetch_assoc()) {
                                ...
                                $names=$row['name']
                                ?>
                                     <div  class="col-md-5 col-lg-5 " style="height:auto;margin:10px; ">
                    ...
                    <div class="row " style="background:white;font-family:Segoe UI regular;font-size:12px;text-align:left;color:#0A62A3;">
                        <?php while($row = $rfileresult->fetch_assoc()) {
                            ...
                            $titles=$row['title'];
                                 $names=$row['name']
                            ?>
                            <div  class="col-md-5 col-lg-5 " style="height:auto;margin:10px; " data-toggle="tooltip" data-placement="bottom" title="Log In & Unlock">
                                <video style="height:340px;width:100%;"  loop autoplay="autoplay"  muted >
                                    <source id="myVideo" name="myVideo" src="admin/uploads/Resources/<?php echo $names; ?>/video/<?php echo $filename; ?>#t=0,22 ">
                                </video>
...
<hr/>
            ...
            $rfilesqls= "SELECT * FROM resources_files where Rid='$resid' and filetype='worksheet'";
            ...
            <div class="row justify-content-md-center " style="background:white;font-family:Segoe UI regular;font-size:12px;text-align:left;color:#0A62A3;">
                ...
                <?php } ?>
                        ...
                        <?php
                        $rfilesqlx= "SELECT * FROM resources_files where Rid='$resid'and filetype='activity'";
        ...
        <?php
        $rfilesqlxt= "SELECT * FROM resources_files where Rid='$resid'and filetype='article'";
...
<!--
    ...
    <?php    $ucsqls= "SELECT * FROM reviews where courseid=$id and type='course' ";
